    ...
    impl ClusterIndexCalculator {
        ...
        fn new(indexes: Vec<String>) -> Self {
            ...
            Self {
                ...
                rubin: index_set.contains("friedman2"),
                mariott: index_set.contains("mariott"),
                scott: index_set.contains("scott1"),
                scott2: index_set.contains("scott2"),
                friedman: index_set.contains("friedman1"),
        ...
        fn compute<'py>(
            ...
            if self.pbm {
                builder = builder.add_pbm();
            }
            if self.sf {
                builder = builder.add_sf();
            }
            if self.sf2 {
                builder = builder.add_sf2();
            }
            if self.sf3 {
                builder = builder.add_sf3();
            }
